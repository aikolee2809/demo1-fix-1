    ...
    >
      <div className="container mx-auto px-6 md:px-12">
        <div className="mb-12 flex flex-col gap-3 md:mb-16">
          ...
          >
            Các kiểu tóc nam & nữ được thực hiện tại salon, từ những đường cắt tỉa tỉ mỉ, kiểu uốn tự nhiên đến những phối màu nhuộm đa chiều. Chúng tôi sẽ mang đến những kiểu tóc vượt cả mong đợi của bạn.
          </p>
        </div>
        ...
        >
          {GALLERY_IMAGES.map((src, i) => (
            ...
            >
              <img
                src={src}
                alt={`Kiểu tóc nam nữ thực tế tại Lái Thiêu ${i + 1}`}
                loading="lazy"
